...
class LearningAgent(Agent):
    ...
    def get_maxQ(self, state):
        ...
        possible_action=self.Q[state]
        maxQ = max(possible_action.items(),key=lambda x:x[1])[1]
...
def run():
    ...
    agent = env.create_agent(LearningAgent,learning=True,epsilon=0.5,alpha=0.002)
